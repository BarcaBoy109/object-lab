...
- [x] Iteration 4 — array and loop visualization. Array heap cards, references, scrollable element layout, and element highlighting are implemented. Browser verification remains pending. Commit: `f306758`.
